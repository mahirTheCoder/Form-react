...
<div className="name">
  ...
  <div className="both flex justify-between">
    <div className="name1 w-[170px] px-2 h-12 border border-[#E8EDF2] rounded-[8px] flex justify-center items-center">
      <input type="text" placeholder='First Name' className='text-sm w-full font-popins text-[#C6CBD9] dark:text-[#2C2C35]'/>
     <RiUserLine className='text-base text[#9A9AAF] dark:text-[#64646F]'/>
    </div>
    <div className="name1 w-[170px] px-2 h-12 border border-[#E8EDF2] rounded-[8px] flex justify-center items-center">
      <input type="text" placeholder='Last name' className='text-sm w-full font-popins text-[#C6CBD9] dark:text-[#2C2C35]'/>
     <RiUserLine className='text-base text[#9A9AAF] dark:text-[#64646F]'/>
    </div>
  </div>
</div>
